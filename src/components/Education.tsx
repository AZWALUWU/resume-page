...
const educationData = [
  {
    ...
    image: "/FreeCodeCamp_logo.svg.png",
    units: [
          ...
          <li key={index} className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0.5 before:bg-gray-600">
            <div className="flex items-start mb-2">
              ...
              <div className="flex-grow">
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-100">{edu.role}</h3>
                <p className="text-base sm:text-lg text-gray-300">{edu.website}</p>
